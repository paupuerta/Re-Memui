...
- **Delete icon button** on each deck card for easy access
...
- **Delete icon button** on each card item for easy access
...
1. **Delete Deck**:
   - **Option 1**: Click the red delete icon button on the deck card
   - **Option 2**: Swipe left on a deck card
...
2. **Delete Card**:
   - **Option 1**: Click the red delete icon button on the card
   - **Option 2**: Swipe left on a card in the deck view
